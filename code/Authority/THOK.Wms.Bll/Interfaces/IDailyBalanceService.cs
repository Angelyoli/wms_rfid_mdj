...
namespace THOK.Wms.Bll.Interfaces
{
    public interface IDailyBalanceService : IService<DailyBalance>
    {
        ...
        object GetInfoDetails(int page, int rows, string warehouseCode, string settleDate, string unitType, string areas);
        ...
        System.Data.DataTable GetInfoDetail(int page, int rows, string warehouseCode, string settleDate, string unitType, string areas = null);
