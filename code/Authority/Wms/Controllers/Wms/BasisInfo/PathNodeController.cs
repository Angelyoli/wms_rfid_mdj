...
namespace Wms.Controllers.Wms.BasisInfo
{
    public class PathNodeController : Controller
    {
        ...
        //    var srm = PathNodeService.GetDetails(page, rows, ID, PathID, PositionID, PathNodeOrder);
        ...
        //
        // POST: /PathNode/Edit
        public ActionResult Edit(PathNode ID)
        {
            string strResult = string.Empty;
            bool bResult = PathNodeService.Save(ID, strResult);
        ...
        [HttpPost]
        public ActionResult Delete(PathNode ID)
        {
            string strResult = string.Empty;
            bool bResult = false;
            bResult = PathNodeService.Delete(ID, strResult);
        ...
        public string PathNodeOrder { get; set; }
    }
}
