...
namespace THOK.Authority.Bll.Interfaces
{
    public interface IUserService : IService<User>
    {
        ...
        bool UpdateUserInfo(string userName, string ipaddress);

        bool CheckAdress(string userName, string ipaddress);
        ...
        System.Data.DataTable GetUser(int page, int rows, string userName, string chineseName, string meMo);
