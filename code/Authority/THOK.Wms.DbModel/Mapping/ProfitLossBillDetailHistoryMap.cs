...
{
   public class ProfitLossBillDetailHistoryMap : EntityMappingBase<ProfitLossBillDetailHistory>
    {
        public ProfitLossBillDetailHistoryMap()
            : base("Wms")
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            // Relationships
            this.HasRequired(t => t.ProfitLossBillMasterHistory)
                .WithMany(t => t.ProfitLossBillDetailHistorys)
