...
namespace DataRabbit.HashOrm
{
	...
	public partial class Storages : IEntity<System.String>,IHashEntity
	{
		...
		public const string _NumberShow = "NumberShow" ;
		...
		#region NumberShow
		private System.String m_NumberShow = "" ; 
		public System.String NumberShow
		{
			get
			{
				if (this._PropertySet.ContainsKey(_NumberShow))
				{
					return (System.String)this._PropertySet[_NumberShow];
				}
				return this.m_NumberShow;
			}
			set
			{
				if (this._PropertySet.ContainsKey(_NumberShow))
				{
					this._PropertySet.Remove(_NumberShow);
				}
				this._PropertySet.Add(_NumberShow, value);
				this.m_NumberShow = value ;
			}
		}
		#endregion
		...
		public string[] ColNames
		{
			get
			{
				string[] strs = {_StorageID,_StorageName,_Row,_Address,_Port,_Act,_ProductName,_Contents,_NumberShow,_Sign,_Err};
				return strs;
			}
		}
		#endregion
